 ...
 * @author Rohan Ranade
 */
public class DefaultActionRefImpl extends StrutsComponentImpl.Named implements DefaultActionRef {

    public DefaultActionRefImpl(StrutsModelImpl model, Element e) {
        super(model, e);
    }

    public DefaultActionRefImpl(StrutsModelImpl model) {
        this(model, createElementNS(model, StrutsQNames.DEFAULT_ACTION_REF));
    }
