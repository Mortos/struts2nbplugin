 ...
 * @author Rohan Ranade
 */
public class InterceptorRefImpl extends StrutsComponentImpl.Named implements InterceptorRef {

    public InterceptorRefImpl(StrutsModelImpl model, Element e) {
        super(model, e);
    }

    public InterceptorRefImpl(StrutsModelImpl model) {
        this(model, createElementNS(model, StrutsQNames.INTERCEPTOR_REF));
    }
