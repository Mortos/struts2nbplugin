...
/**
 * Provides completion items for a bean tag's class attribute value.
 * Looks at the tag's type attribute, if defined, to provide only 
 * implementations of that interface as smart items, otherwise provides 
 * the whole list
 * 
 ...
 */
public class BeanClassCompletor extends JavaClassCompletor {

    public BeanClassCompletor() {
    }

    @Override
    protected void addNormalTypes(CompilationController cc, ClassIndex ci, List<StrutsXMLConfigCompletionItem> results, 
