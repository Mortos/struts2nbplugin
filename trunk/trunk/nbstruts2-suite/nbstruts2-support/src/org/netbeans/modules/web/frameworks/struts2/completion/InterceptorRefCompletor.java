 ...
 */
public class InterceptorRefCompletor extends Completor {

    public InterceptorRefCompletor() {
    }
    ...
    public List<StrutsXMLConfigCompletionItem> doCompletion(final CompletionContext context) {
        ...
        for(String interceptorName : name2Interceptor.keySet()) {
            ...
            StrutsXMLConfigCompletionItem item = StrutsXMLConfigCompletionItem.createInterceptorRefItem(substitutionOffset, interceptorName, implClass);
            results.add(item);
        }
