 ...
 */
public class StrutsPackageItem extends StrutsXMLConfigCompletionItem {
    ...
    public StrutsPackageItem(int substitutionOffset, String displayName, FileObject file) {
        super(substitutionOffset);
        this.displayName = displayName;
        this.fileShortName = file.getNameExt();
    ...
    public CompletionTask createDocumentationTask() {
        if (docText == null) {
            StringBuilder sb = new StringBuilder();
            sb.append("<b>"); // NOI18N
            sb.append(NbBundle.getMessage(ResultItem.class, "MESG_Package_File"));
            sb.append("</b>"); // NOI18N
            sb.append(filePath);
            docText = sb.toString();
        }
