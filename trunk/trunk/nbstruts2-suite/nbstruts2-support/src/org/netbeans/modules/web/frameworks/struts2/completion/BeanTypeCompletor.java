...
/**
 * Provides completion items for a bean tag's type attribute value.
 * Looks at the tag's class attribute, if defined, to provide only 
 * interfaces implemented as smart items, otherwise provides 
 * the whole list
 * 
 * FIXME: To implement smart completion items logic
 * 
 * @author Rohan Ranade (Rohan.Ranade@Sun.COM)
 */
public class BeanTypeCompletor extends JavaClassCompletor {

    public BeanTypeCompletor() {
    }
    ...
    protected void addNormalTypes(CompilationController cc, ClassIndex ci,
        ...
        List<TypeElement> tes = new TypeScanner(EnumSet.of(ElementKind.INTERFACE)).scan(packageElem);
    ...
    @Override
    protected void addSmartTypes(CompilationController cc, ClassIndex ci, List<StrutsXMLConfigCompletionItem> results, String typedPrefix, String packageName, int substitutionOffset) {
