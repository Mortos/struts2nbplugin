 ...
 * @author Rohan Ranade
 */
public class UnknownHandlerRefImpl extends StrutsComponentImpl.Named implements UnknownHandlerRef {

    public UnknownHandlerRefImpl(StrutsModelImpl model, Element e) {
        super(model, e);
    }

    public UnknownHandlerRefImpl(StrutsModelImpl model) {
