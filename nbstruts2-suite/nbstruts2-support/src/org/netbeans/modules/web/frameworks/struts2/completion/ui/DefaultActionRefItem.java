 ...
 */
 public class DefaultActionRefItem extends StrutsXMLConfigCompletionItem {

        private String displayName;
        private String actionClass;
        private String docText;

        public DefaultActionRefItem(int substitutionOffset, String displayName, String actionClass) {
        ...
        public CompletionTask createDocumentationTask() {
            if(docText == null) {
                ...
                sb.append("<b>"); // NOI18N
                sb.append(NbBundle.getMessage(DefaultActionRefItem.class, "MESG_Interceptor_Doc"));
                sb.append("</b>"); // NOI18N
