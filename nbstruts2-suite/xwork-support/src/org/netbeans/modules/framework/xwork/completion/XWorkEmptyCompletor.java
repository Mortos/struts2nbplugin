 ...
 * @author Aleh
 */
public final class XWorkEmptyCompletor implements XWorkCompletor {

    private static final XWorkCompletor INSTANCE = new XWorkEmptyCompletor();

    private XWorkEmptyCompletor() {
    }
    ...
    public static XWorkCompletor instance() {
        return INSTANCE;
    }
}
