 ...
 * @author Aleh
 */
public enum XWorkValidatorCompletionItemIcon {

    ATTRIBUTE_ICON("attribute.png"),
    ELEMENT_ICON("element.png"),
    VALUE_ICON("value.png");
    private static final String ICONS_PACKAGE = "org/netbeans/modules/framework/xwork/completion/validator/resource";
    private ImageIcon icon;

    private XWorkValidatorCompletionItemIcon(String iconName) {
        try {
