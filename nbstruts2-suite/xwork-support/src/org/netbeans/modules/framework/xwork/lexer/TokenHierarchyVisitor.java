...
/**
 * Interface for performing document operations under read lock.
 *
 * @author Aleh Maksimovich
 * @since 0.5.1
 */
public interface TokenHierarchyVisitor<T extends AbstractDocument> {

    void visit(TokenHierarchy<T> tokenHierarchy) throws TokenHierarchyVisitorException;
}
